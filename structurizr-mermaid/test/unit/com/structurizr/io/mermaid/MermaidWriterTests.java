...
public class MermaidWriterTests {
    ...
    public void test() throws Exception {
        ...
        assertEquals("graph TB\n" +
                ...
                "    style 15 fill:#999999,stroke:#bbbbbb,color:#ffffff\n" +
                ...
                "    style 12 fill:#999999,stroke:#bbbbbb,color:#ffffff\n" +
                ...
                "    style 9 fill:#999999,stroke:#bbbbbb,color:#ffffff\n" +
                ...
                "    style 6 fill:#999999,stroke:#bbbbbb,color:#ffffff\n" +
                ...
                "    style 4 fill:#999999,stroke:#bbbbbb,color:#ffffff\n" +
                "  end\n" +
        ...
        assertEquals("graph TB\n" +
                ...
                "    style 20 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                ...
                "    style 21 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                ...
                "    style 18 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                ...
                "    style 17 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                ...
                "    style 19 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                "  end\n" +
                "  style boundary fill:#ffffff,stroke:#000000,color:#000000\n" +
        ...
        assertEquals("graph TB\n" +
                ...
                "    style 30 fill:#85bbf0,stroke:#bbbbbb,color:#000000\n" +
                ...
                "    style 34 fill:#85bbf0,stroke:#bbbbbb,color:#000000\n" +
                ...
                "    style 33 fill:#85bbf0,stroke:#bbbbbb,color:#000000\n" +
                ...
                "    style 31 fill:#85bbf0,stroke:#bbbbbb,color:#000000\n" +
                ...
                "    style 32 fill:#85bbf0,stroke:#bbbbbb,color:#000000\n" +
                ...
                "    style 29 fill:#85bbf0,stroke:#bbbbbb,color:#000000\n" +
                "  end\n" +
                "  style boundary fill:#ffffff,stroke:#000000,color:#000000\n" +
        ...
        assertEquals("graph TB\n" +
                ...
                "          style 57 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                "      end\n" +
        ...
        assertEquals("graph TB\n" +
                ...
                "          style 75 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                "      end\n" +
                ...
                "          style 80 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                "      end\n" +
                ...
                "          style 84 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                "      end\n" +
                ...
                "        style 67 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                "    end\n" +
                ...
                "      style 64 fill:#438dd5,stroke:#bbbbbb,color:#ffffff\n" +
                "  end\n" +
